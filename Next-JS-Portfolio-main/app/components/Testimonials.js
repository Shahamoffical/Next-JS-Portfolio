    ...
    <section id="testimonials" className="testimonials-section py-24 px-6 md:px-12 max-w-7xl mx-auto bg-white overflow-hidden w-full">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-5 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-text-heading leading-tight m-0 font-sans">
            Client Success Stories
          </h2>
          <h3 className="text-xl font-semibold text-primary m-0 font-sans">
            What Our Partners Say
          </h3>
          
          <p className="text-text-secondary text-sm mb-6 max-w-sm leading-relaxed font-light">
            We focus on building custom websites that load under 2 seconds, convert visitors to clients, and achieve top Google Maps local rankings.
          </p>

          <div className="bg-white rounded-3xl p-6 shadow-[0_12px_30px_rgba(192,0,0,0.145)] border border-primary/40 max-w-sm">
        ...
        <div className="md:col-span-7 relative pt-8 md:pt-12">
          ...
          {/* Testimonial Card */}
          <div className="relative z-10 bg-white rounded-3xl p-8 md:p-10 shadow-[0_12px_30px_rgba(192,0,0,0.145)] border border-primary/40 mb-8 min-h-[250px] flex flex-col justify-between">
            <div ref={slideRef}>
